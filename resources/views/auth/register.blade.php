        ...
        <div class="bg-white rounded-[32px] shadow-xl w-full max-w-6xl flex overflow-hidden">
            ...
            <div class="w-full lg:w-1/2 p-12">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <!-- Social Sign Up -->
                    <div class="mt-8">
                        <p class="text-center text-sm text-gray-500 mb-4">Or Sign Up With</p>
                        <div class="flex justify-center items-center space-x-4">
                            ...
                            <a href="#" class="p-2 hover:opacity-80 transition-opacity duration-200">
                                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 2C14.717 2 15.056 2.01 16.122 2.06C17.187 2.11 17.912 2.277 18.55 2.525C19.21 2.779 19.766 3.123 20.322 3.678C20.8305 4.1779 21.224 4.78259 21.475 5.45C21.722 6.087 21.89 6.813 21.94 7.878C21.987 8.944 22 9.283 22 12C22 14.717 21.99 15.056 21.94 16.122C21.89 17.187 21.722 17.912 21.475 18.55C21.2247 19.2178 20.8311 19.8226 20.322 20.322C19.822 20.8303 19.2173 21.2238 18.55 21.475C17.913 21.722 17.187 21.89 16.122 21.94C15.056 21.987 14.717 22 12 22C9.283 22 8.944 21.99 7.878 21.94C6.813 21.89 6.088 21.722 5.45 21.475C4.78233 21.2245 4.17753 20.8309 3.678 20.322C3.16941 19.8222 2.77593 19.2175 2.525 18.55C2.277 17.913 2.11 17.187 2.06 16.122C2.013 15.056 2 14.717 2 12C2 9.283 2.01 8.944 2.06 7.878C2.11 6.812 2.277 6.088 2.525 5.45C2.77524 4.78218 3.1688 4.17732 3.678 3.678C4.17767 3.16923 4.78243 2.77573 5.45 2.525C6.088 2.277 6.812 2.11 7.878 2.06C8.944 2.013 9.283 2 12 2Z" fill="url(#paint0_radial_87_7153)"/>
                                    <path d="M12 2C14.717 2 15.056 2.01 16.122 2.06C17.187 2.11 17.912 2.277 18.55 2.525C19.21 2.779 19.766 3.123 20.322 3.678C20.8305 4.1779 21.224 4.78259 21.475 5.45C21.722 6.087 21.89 6.813 21.94 7.878C21.987 8.944 22 9.283 22 12C22 14.717 21.99 15.056 21.94 16.122C21.89 17.187 21.722 17.912 21.475 18.55C21.2247 19.2178 20.8311 19.8226 20.322 20.322C19.822 20.8303 19.2173 21.2238 18.55 21.475C17.913 21.722 17.187 21.89 16.122 21.94C15.056 21.987 14.717 22 12 22C9.283 22 8.944 21.99 7.878 21.94C6.813 21.89 6.088 21.722 5.45 21.475C4.78233 21.2245 4.17753 20.8309 3.678 20.322C3.16941 19.8222 2.77593 19.2175 2.525 18.55C2.277 17.913 2.11 17.187 2.06 16.122C2.013 15.056 2 14.717 2 12C2 9.283 2.01 8.944 2.06 7.878C2.11 6.812 2.277 6.088 2.525 5.45C2.77524 4.78218 3.1688 4.17732 3.678 3.678C4.17767 3.16923 4.78243 2.77573 5.45 2.525C6.088 2.277 6.812 2.11 7.878 2.06C8.944 2.013 9.283 2 12 2Z" fill="url(#paint1_radial_87_7153)"/>
                                    <path d="M11.9999 15.3308C13.8409 15.3308 15.3307 13.841 15.3307 12C15.3307 10.159 13.8409 8.66919 11.9999 8.66919C10.1589 8.66919 8.66907 10.159 8.66907 12C8.66907 13.841 10.1589 15.3308 11.9999 15.3308Z" fill="white"/>
                                    <path d="M16.3338 7.84615C16.3338 8.32265 15.9487 8.70775 15.4722 8.70775C14.9957 8.70775 14.6106 8.32265 14.6106 7.84615C14.6106 7.36965 14.9957 6.98455 15.4722 6.98455C15.9487 6.98455 16.3338 7.36965 16.3338 7.84615Z" fill="white"/>
                                    <defs>
                                        <radialGradient id="paint0_radial_87_7153" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(6.375 21.7222) rotate(-90) scale(19.8215 18.4355)">
                                            <stop stop-color="#FFDD55"/>
                                            <stop offset="0.1" stop-color="#FFDD55"/>
                                            <stop offset="0.5" stop-color="#FF543E"/>
                                            <stop offset="1" stop-color="#C837AB"/>
                                        </radialGradient>
                                        <radialGradient id="paint1_radial_87_7153" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(-4.02133 3.24375) rotate(78.681) scale(8.86031 36.5225)">
                    ...
                    <p class="text-center text-sm text-gray-500 mt-8">
                        ...
                        <a href="{{ route('login') }}" class="text-[#6C63FF] hover:underline">Sign In</a>
                    </p>
                </form>
            </div>
        </div>
